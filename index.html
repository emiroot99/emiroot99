  ...
  <body>
            ...
            <section id="hero" class="text-white tm-font-big tm-parallax">
              ...
              <nav class="navbar navbar-expand-md tm-navbar" id="tmNav">
                <div class="container">
                  <div class="tm-next">
                      <a href="#hero" class="navbar-brand">Emiliano</a>
                  </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                      <li>
                        <iframe src="https://rcm-eu.amazon-adsystem.com/e/cm?o=29&p=48&l=ur1&category=prime_video&banner=0QB1BTG85GDJAT5BZ002&f=ifr&linkID=6b753a082bbddc5b6c56275b8d0af16d&t=emiroot99-21&tracking_id=emiroot99-21" width="720" height="90" scrolling="no" border="0" marginwidth="0" style="border:none;" frameborder="0"></iframe><br>
                      </li>
                      <li class="nav-item">
              ...
              <div class="text-center tm-hero-text-container">
                <div class="tm-hero-text-container-inner">
                    <h2 class="tm-hero-title">Emiliano</h2>
                    <p class="tm-hero-subtitle">
                            Studente di indirizzo informatico
                      <br>by Dedsec
                    </p>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <div class="tm-intro-text-container">
                ...
                <p class="mb-4 tm-intro-text">
                  Mi chiamo <strong>Emiliano Cancedda</strong> e sono uno studente autodidatta di indirizzo informatico,
                  presso l'istituto IIS-Giorgi Woolf di Roma. Sono appassionato di <strong>programmazione</strong> dalla seconda media e sono due anni che studio <strong>ethical hacking.</strong>
              </p> 
    ...
    <section id="banner" class="tm-section-pad-top">
      BANNER<br>
      <iframe src="https://rcm-eu.amazon-adsystem.com/e/cm?o=29&p=288&l=ur1&category=primestudent_it&banner=09M0PBV17RWDN109J782&f=ifr&linkID=befabedd250b0fe107a4864a5c4c5169&t=emiroot99-21&tracking_id=emiroot99-21" width="320" height="50" scrolling="no" border="0" marginwidth="0" style="border:none;" frameborder="0"></iframe>
    </section>
    ...
    <section id="contact" class="tm-section-pad-top tm-parallax-2">
      ...
      <footer class="text-center small tm-footer">
          <p class="mb-0">
            Copyright &copy; 2019 Emi's Portfolio
